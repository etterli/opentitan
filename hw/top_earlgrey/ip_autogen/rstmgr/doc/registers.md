...
<!-- BEGIN CMDGEN util/regtool.py -d ./hw/top_earlgrey/ip_autogen/rstmgr/data/rstmgr.hjson -->
## Summary
...
| rstmgr.[`SW_RST_REGWEN_9`](#sw_rst_regwen)   | 0x50     |        4 | Register write enable for software controllable resets.            |
| rstmgr.[`SW_RST_REGWEN_10`](#sw_rst_regwen)  | 0x54     |        4 | Register write enable for software controllable resets.            |
| rstmgr.[`SW_RST_REGWEN_11`](#sw_rst_regwen)  | 0x58     |        4 | Register write enable for software controllable resets.            |
| rstmgr.[`SW_RST_CTRL_N_0`](#sw_rst_ctrl_n)   | 0x5c     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_1`](#sw_rst_ctrl_n)   | 0x60     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_2`](#sw_rst_ctrl_n)   | 0x64     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_3`](#sw_rst_ctrl_n)   | 0x68     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_4`](#sw_rst_ctrl_n)   | 0x6c     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_5`](#sw_rst_ctrl_n)   | 0x70     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_6`](#sw_rst_ctrl_n)   | 0x74     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_7`](#sw_rst_ctrl_n)   | 0x78     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_8`](#sw_rst_ctrl_n)   | 0x7c     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_9`](#sw_rst_ctrl_n)   | 0x80     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_10`](#sw_rst_ctrl_n)  | 0x84     |        4 | Software controllable resets.                                      |
| rstmgr.[`SW_RST_CTRL_N_11`](#sw_rst_ctrl_n)  | 0x88     |        4 | Software controllable resets.                                      |
| rstmgr.[`ERR_CODE`](#err_code)               | 0x8c     |        4 | A bit vector of all the errors that have occurred in reset manager |
...
b3: sysrst_ctrl: OpenTitan reset request to `rstmgr` (running on AON clock).
b4: aon_timer: Watchdog reset request.
b5: pwrmgr: main power glitch reset request
...
| SW_RST_REGWEN_9  | 0x50     |
| SW_RST_REGWEN_10 | 0x54     |
| SW_RST_REGWEN_11 | 0x58     |
...
| Name             | Offset   |
|:-----------------|:---------|
| SW_RST_CTRL_N_0  | 0x5c     |
| SW_RST_CTRL_N_1  | 0x60     |
| SW_RST_CTRL_N_2  | 0x64     |
| SW_RST_CTRL_N_3  | 0x68     |
| SW_RST_CTRL_N_4  | 0x6c     |
| SW_RST_CTRL_N_5  | 0x70     |
| SW_RST_CTRL_N_6  | 0x74     |
| SW_RST_CTRL_N_7  | 0x78     |
| SW_RST_CTRL_N_8  | 0x7c     |
| SW_RST_CTRL_N_9  | 0x80     |
| SW_RST_CTRL_N_10 | 0x84     |
| SW_RST_CTRL_N_11 | 0x88     |
