...
module rstmgr_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[23] = (reg_addr == RSTMGR_SW_RST_CTRL_N_0_OFFSET);
    addr_hit[24] = (reg_addr == RSTMGR_SW_RST_CTRL_N_1_OFFSET);
    addr_hit[25] = (reg_addr == RSTMGR_SW_RST_CTRL_N_2_OFFSET);
    addr_hit[26] = (reg_addr == RSTMGR_SW_RST_CTRL_N_3_OFFSET);
    addr_hit[27] = (reg_addr == RSTMGR_SW_RST_CTRL_N_4_OFFSET);
    addr_hit[28] = (reg_addr == RSTMGR_SW_RST_CTRL_N_5_OFFSET);
    addr_hit[29] = (reg_addr == RSTMGR_SW_RST_CTRL_N_6_OFFSET);
    addr_hit[30] = (reg_addr == RSTMGR_SW_RST_CTRL_N_7_OFFSET);
    addr_hit[31] = (reg_addr == RSTMGR_SW_RST_CTRL_N_8_OFFSET);
    addr_hit[32] = (reg_addr == RSTMGR_SW_RST_CTRL_N_9_OFFSET);
    addr_hit[33] = (reg_addr == RSTMGR_SW_RST_CTRL_N_10_OFFSET);
    addr_hit[34] = (reg_addr == RSTMGR_SW_RST_CTRL_N_11_OFFSET);
    addr_hit[35] = (reg_addr == RSTMGR_ERR_CODE_OFFSET);
  end
  ...
  assign sw_rst_ctrl_n_0_we = addr_hit[23] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_0_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_1_we = addr_hit[24] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_1_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_2_we = addr_hit[25] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_2_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_3_we = addr_hit[26] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_3_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_4_we = addr_hit[27] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_4_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_5_we = addr_hit[28] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_5_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_6_we = addr_hit[29] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_6_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_7_we = addr_hit[30] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_7_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_8_we = addr_hit[31] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_8_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_9_we = addr_hit[32] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_9_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_10_we = addr_hit[33] & reg_we & !reg_error;

  assign sw_rst_ctrl_n_10_wd = reg_wdata[0];
  assign sw_rst_ctrl_n_11_we = addr_hit[34] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    reg_we_check[23] = sw_rst_ctrl_n_0_gated_we;
    reg_we_check[24] = sw_rst_ctrl_n_1_gated_we;
    reg_we_check[25] = sw_rst_ctrl_n_2_gated_we;
    reg_we_check[26] = sw_rst_ctrl_n_3_gated_we;
    reg_we_check[27] = sw_rst_ctrl_n_4_gated_we;
    reg_we_check[28] = sw_rst_ctrl_n_5_gated_we;
    reg_we_check[29] = sw_rst_ctrl_n_6_gated_we;
    reg_we_check[30] = sw_rst_ctrl_n_7_gated_we;
    reg_we_check[31] = sw_rst_ctrl_n_8_gated_we;
    reg_we_check[32] = sw_rst_ctrl_n_9_gated_we;
    reg_we_check[33] = sw_rst_ctrl_n_10_gated_we;
    reg_we_check[34] = sw_rst_ctrl_n_11_gated_we;
