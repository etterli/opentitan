...
module top_earlgrey #(
  ...
  ast_pkg::second_to_prim_t       ast_second_to_prim;
  ast_pkg::prim_to_second_t       ast_prim_to_second;
  ...
  .SramCtrlMetaEccCorrection(SramCtrlMetaEccCorrection)
    ...
    .ast_second_to_prim_i                  (ast_second_to_prim       ),
    .ast_prim_to_second_o                  (ast_prim_to_second       ),
  ...
  .SramCtrlRetEccCorrection(SramCtrlRetEccCorrection)
    ...
    .ast_second_to_prim_o                  (ast_second_to_prim       ),
    .ast_prim_to_second_i                  (ast_prim_to_second       ),
