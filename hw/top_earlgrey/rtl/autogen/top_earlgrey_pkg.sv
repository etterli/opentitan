...
package top_earlgrey_pkg;
   ...
   */
  parameter int unsigned TOP_EARLGREY_I3C0_BASE_ADDR = 32'h40330000;

  /**
   * Peripheral size in bytes for i3c0 in top earlgrey.
   */
  parameter int unsigned TOP_EARLGREY_I3C0_SIZE_BYTES = 32'h2000;

  /**
   * Peripheral base address for i3c1 in top earlgrey.
   */
  parameter int unsigned TOP_EARLGREY_I3C1_BASE_ADDR = 32'h40340000;

  /**
   * Peripheral size in bytes for i3c1 in top earlgrey.
   */
  parameter int unsigned TOP_EARLGREY_I3C1_SIZE_BYTES = 32'h2000;
   ...
   */
  parameter int unsigned TOP_EARLGREY_RSTMGR_SIZE_BYTES = 32'h100;
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyAlertPeripheralI3c0 = 15,
    TopEarlgreyAlertPeripheralI3c1 = 16,
    TopEarlgreyAlertPeripheralPwrmgr = 17,
    TopEarlgreyAlertPeripheralRstmgr = 18,
    TopEarlgreyAlertPeripheralClkmgr = 19,
    TopEarlgreyAlertPeripheralSysrstCtrl = 20,
    TopEarlgreyAlertPeripheralAdcCtrl = 21,
    TopEarlgreyAlertPeripheralPinmux = 22,
    TopEarlgreyAlertPeripheralAonTimer = 23,
    TopEarlgreyAlertPeripheralSensorCtrl = 24,
    TopEarlgreyAlertPeripheralSramCtrlRet = 25,
    ...
    TopEarlgreyAlertPeripheralKeymgrDpe = 34,
    ...
    TopEarlgreyAlertPeripheralSramCtrlSec = 40,
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyAlertIdI3c0FatalFault = 21,
    TopEarlgreyAlertIdI3c1FatalFault = 22,
    TopEarlgreyAlertIdPwrmgrFatalFault = 23,
    TopEarlgreyAlertIdRstmgrFatalFault = 24,
    TopEarlgreyAlertIdRstmgrFatalCnstyFault = 25,
    TopEarlgreyAlertIdClkmgrRecovFault = 26,
    TopEarlgreyAlertIdClkmgrFatalFault = 27,
    TopEarlgreyAlertIdSysrstCtrlFatalFault = 28,
    TopEarlgreyAlertIdAdcCtrlFatalFault = 29,
    TopEarlgreyAlertIdPinmuxFatalFault = 30,
    TopEarlgreyAlertIdAonTimerFatalFault = 31,
    TopEarlgreyAlertIdSensorCtrlRecovAlert = 32,
    TopEarlgreyAlertIdSensorCtrlFatalAlert = 33,
    TopEarlgreyAlertIdSramCtrlRetFatalError = 34,
    ...
    TopEarlgreyAlertIdKeymgrDpeRecovOperationErr = 54,
    TopEarlgreyAlertIdKeymgrDpeFatalFaultErr = 55,
    ...
    TopEarlgreyAlertIdSramCtrlSecFatalError = 65,
    TopEarlgreyAlertIdRomCtrlFatal = 66,
    TopEarlgreyAlertIdRvCoreIbexFatalSwErr = 67,
    TopEarlgreyAlertIdRvCoreIbexRecovSwErr = 68,
    TopEarlgreyAlertIdRvCoreIbexFatalHwErr = 69,
    TopEarlgreyAlertIdRvCoreIbexRecovHwErr = 70,
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyPlicIrqIdI3c0Hci = 151,
    TopEarlgreyPlicIrqIdI3c0Targ = 152,
    TopEarlgreyPlicIrqIdI3c1Hci = 153,
    TopEarlgreyPlicIrqIdI3c1Targ = 154,
    TopEarlgreyPlicIrqIdPwrmgrWakeup = 155,
    TopEarlgreyPlicIrqIdSysrstCtrlEventDetected = 156,
    TopEarlgreyPlicIrqIdAdcCtrlMatchPending = 157,
    TopEarlgreyPlicIrqIdAonTimerWkupTimerExpired = 158,
    TopEarlgreyPlicIrqIdAonTimerWdogTimerBark = 159,
    TopEarlgreyPlicIrqIdSensorCtrlIoStatusChange = 160,
    TopEarlgreyPlicIrqIdSensorCtrlInitStatusChange = 161,
    TopEarlgreyPlicIrqIdFlashCtrlProgEmpty = 162,
    TopEarlgreyPlicIrqIdFlashCtrlProgLvl = 163,
    TopEarlgreyPlicIrqIdFlashCtrlRdFull = 164,
    TopEarlgreyPlicIrqIdFlashCtrlRdLvl = 165,
    TopEarlgreyPlicIrqIdFlashCtrlOpDone = 166,
    TopEarlgreyPlicIrqIdFlashCtrlCorrErr = 167,
    TopEarlgreyPlicIrqIdRramCtrlWrEmpty = 168,
    TopEarlgreyPlicIrqIdRramCtrlWrLvl = 169,
    TopEarlgreyPlicIrqIdRramCtrlRdFull = 170,
    TopEarlgreyPlicIrqIdRramCtrlRdLvl = 171,
    TopEarlgreyPlicIrqIdRramCtrlOpDone = 172,
    TopEarlgreyPlicIrqIdRramCtrlCorrErr = 173,
    TopEarlgreyPlicIrqIdHmacHmacDone = 174,
    TopEarlgreyPlicIrqIdHmacFifoEmpty = 175,
    TopEarlgreyPlicIrqIdHmacHmacErr = 176,
    TopEarlgreyPlicIrqIdKmacKmacDone = 177,
    TopEarlgreyPlicIrqIdKmacFifoEmpty = 178,
    TopEarlgreyPlicIrqIdKmacKmacErr = 179,
    TopEarlgreyPlicIrqIdOtbnDone = 180,
    TopEarlgreyPlicIrqIdKeymgrDpeOpDone = 181,
    TopEarlgreyPlicIrqIdCsrngCsCmdReqDone = 182,
    TopEarlgreyPlicIrqIdCsrngCsEntropyReq = 183,
    TopEarlgreyPlicIrqIdCsrngCsHwInstExc = 184,
    TopEarlgreyPlicIrqIdCsrngCsFatalErr = 185,
    TopEarlgreyPlicIrqIdEntropySrcEsEntropyValid = 186,
    TopEarlgreyPlicIrqIdEntropySrcEsHealthTestFailed = 187,
    TopEarlgreyPlicIrqIdEntropySrcEsObserveFifoReady = 188,
    TopEarlgreyPlicIrqIdEntropySrcEsFatalErr = 189,
    TopEarlgreyPlicIrqIdEdn0EdnCmdReqDone = 190,
    TopEarlgreyPlicIrqIdEdn0EdnFatalErr = 191,
    TopEarlgreyPlicIrqIdEdn1EdnCmdReqDone = 192,
    TopEarlgreyPlicIrqIdEdn1EdnFatalErr = 193,
