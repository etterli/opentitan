...
module earlgrey_pd_aon #(
  ...
  output ast_pkg::second_to_prim_t       ast_second_to_prim_o,
  input  ast_pkg::prim_to_second_t       ast_prim_to_second_i,
  ...
  ast_part_secondary #(
    ...
    .second_to_prim_o(ast_second_to_prim_o),
    .prim_to_second_i(ast_prim_to_second_i)
  );
