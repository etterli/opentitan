...
<%
  ...
  mem_cfg_consumers = [
    ('otbn_imem',                'otbn_ram_cfg_imem',                '1p',   None),
    ('otbn_dmem',                'otbn_ram_cfg_dmem',                '1p',   None),
    ('i2c0',                     'i2c0_ram_cfg',                     '1p',   None),
    ('i2c1',                     'i2c1_ram_cfg',                     '1p',   None),
    ('i2c2',                     'i2c2_ram_cfg',                     '1p',   None),
    ('usbdev_ram',               'usbdev_ram_cfg',                   '1p',   None),
    ('rv_core_ibex_icache_tag',  'rv_core_ibex_ram_cfg_icache_tag',  '1p',   'ibex_pkg::IC_NUM_WAYS'),
    ('rv_core_ibex_icache_data', 'rv_core_ibex_ram_cfg_icache_data', '1p',   'ibex_pkg::IC_NUM_WAYS'),
    ...
    ('spi_device_sys2spi',       'spi_device_ram_cfg_sys2spi',       '1r1w', None),
    ('spi_device_spi2sys',       'spi_device_ram_cfg_spi2sys',       '1r1w', None),
