...
assign pwrmgr_o = '{
  slow_clk_val: clks_byp_second_to_prim.clk_src_aon_val_o,
  core_clk_val: prim_to_second_i.pwrmgr_rsp.clk_src_sys_val,
  io_clk_val:   prim_to_second_i.pwrmgr_rsp.clk_src_io_val,
  usb_clk_val:  prim_to_second_i.pwrmgr_rsp.clk_src_usb_val,
  main_pok:     ast_pwst.main_pok
};

// Forward the pwrmgr requests
assign second_to_prim_o.pwrmgr_req = '{
...
assign second_to_prim_o.mem_cfg_req = primary_mem_cfg_req;
