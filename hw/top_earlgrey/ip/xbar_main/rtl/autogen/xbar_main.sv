...
module xbar_main (
  ...
  input  tlul_pkg::tl_d2h_t tl_rram_ctrl__core_i,
  output tlul_pkg::tl_h2d_t tl_rram_macro__prim_o,
  input  tlul_pkg::tl_d2h_t tl_rram_macro__prim_i,
  output tlul_pkg::tl_h2d_t tl_rram_ctrl__host_o,
  input  tlul_pkg::tl_d2h_t tl_rram_ctrl__host_i,
  ...
  output tlul_pkg::tl_h2d_t tl_sram_ctrl_sec__regs_o,
  input  tlul_pkg::tl_d2h_t tl_sram_ctrl_sec__regs_i,
  ...
  tl_h2d_t tl_s1n_34_ds_h2d [6];
  tl_d2h_t tl_s1n_34_ds_d2h [6];

  // Create steering signal
  logic [2:0] dev_sel_s1n_34;
  ...
  tl_h2d_t tl_s1n_73_us_h2d ;
  tl_d2h_t tl_s1n_73_us_d2h ;


  tl_h2d_t tl_s1n_73_ds_h2d [31];
  tl_d2h_t tl_s1n_73_ds_d2h [31];

  // Create steering signal
  logic [4:0] dev_sel_s1n_73;



  assign tl_sm1_35_us_h2d[0] = tl_s1n_34_ds_h2d[0];
  assign tl_s1n_34_ds_d2h[0] = tl_sm1_35_us_d2h[0];

  assign tl_sm1_36_us_h2d[0] = tl_s1n_34_ds_h2d[1];
  assign tl_s1n_34_ds_d2h[1] = tl_sm1_36_us_d2h[0];

  assign tl_sm1_37_us_h2d[0] = tl_s1n_34_ds_h2d[2];
  assign tl_s1n_34_ds_d2h[2] = tl_sm1_37_us_d2h[0];

  assign tl_sm1_38_us_h2d[0] = tl_s1n_34_ds_h2d[3];
  assign tl_s1n_34_ds_d2h[3] = tl_sm1_38_us_d2h[0];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_34_ds_h2d[4];
  assign tl_s1n_34_ds_d2h[4] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_34_ds_h2d[5];
  assign tl_s1n_34_ds_d2h[5] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_41_ds_h2d[0];
  assign tl_s1n_41_ds_d2h[0] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_41_ds_h2d[1];
  assign tl_s1n_41_ds_d2h[1] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_41_ds_h2d[2];
  assign tl_s1n_41_ds_d2h[2] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_41_ds_h2d[3];
  assign tl_s1n_41_ds_d2h[3] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_37_us_h2d[1] = tl_s1n_41_ds_h2d[4];
  assign tl_s1n_41_ds_d2h[4] = tl_sm1_37_us_d2h[1];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_41_ds_h2d[5];
  assign tl_s1n_41_ds_d2h[5] = tl_sm1_38_us_d2h[1];
  ...
  assign tl_sm1_57_us_h2d[0] = tl_s1n_41_ds_h2d[13];
  assign tl_s1n_41_ds_d2h[13] = tl_sm1_57_us_d2h[0];
  ...
  assign tl_sm1_40_us_h2d[1] = tl_s1n_41_ds_h2d[16];
  assign tl_s1n_41_ds_d2h[16] = tl_sm1_40_us_d2h[1];
  ...
  assign tl_sm1_35_us_h2d[2] = tl_s1n_73_ds_h2d[0];
  assign tl_s1n_73_ds_d2h[0] = tl_sm1_35_us_d2h[2];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_73_ds_h2d[1];
  assign tl_s1n_73_ds_d2h[1] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_36_us_h2d[2] = tl_s1n_73_ds_h2d[2];
  assign tl_s1n_73_ds_d2h[2] = tl_sm1_36_us_d2h[2];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_73_ds_h2d[3];
  assign tl_s1n_73_ds_d2h[3] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_37_us_h2d[2] = tl_s1n_73_ds_h2d[4];
  assign tl_s1n_73_ds_d2h[4] = tl_sm1_37_us_d2h[2];

  assign tl_sm1_38_us_h2d[2] = tl_s1n_73_ds_h2d[5];
  assign tl_s1n_73_ds_d2h[5] = tl_sm1_38_us_d2h[2];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_73_ds_h2d[6];
  assign tl_s1n_73_ds_d2h[6] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_47_us_h2d[1] = tl_s1n_73_ds_h2d[7];
  assign tl_s1n_73_ds_d2h[7] = tl_sm1_47_us_d2h[1];

  assign tl_sm1_49_us_h2d[1] = tl_s1n_73_ds_h2d[8];
  assign tl_s1n_73_ds_d2h[8] = tl_sm1_49_us_d2h[1];

  assign tl_sm1_51_us_h2d[1] = tl_s1n_73_ds_h2d[9];
  assign tl_s1n_73_ds_d2h[9] = tl_sm1_51_us_d2h[1];

  assign tl_sm1_53_us_h2d[1] = tl_s1n_73_ds_h2d[10];
  assign tl_s1n_73_ds_d2h[10] = tl_sm1_53_us_d2h[1];

  assign tl_sm1_55_us_h2d[1] = tl_s1n_73_ds_h2d[11];
  assign tl_s1n_73_ds_d2h[11] = tl_sm1_55_us_d2h[1];

  assign tl_sm1_56_us_h2d[1] = tl_s1n_73_ds_h2d[12];
  assign tl_s1n_73_ds_d2h[12] = tl_sm1_56_us_d2h[1];

  assign tl_sm1_57_us_h2d[1] = tl_s1n_73_ds_h2d[13];
  assign tl_s1n_73_ds_d2h[13] = tl_sm1_57_us_d2h[1];

  assign tl_sm1_39_us_h2d[2] = tl_s1n_73_ds_h2d[14];
  assign tl_s1n_73_ds_d2h[14] = tl_sm1_39_us_d2h[2];

  assign tl_sm1_58_us_h2d[1] = tl_s1n_73_ds_h2d[15];
  assign tl_s1n_73_ds_d2h[15] = tl_sm1_58_us_d2h[1];

  assign tl_sm1_40_us_h2d[2] = tl_s1n_73_ds_h2d[16];
  assign tl_s1n_73_ds_d2h[16] = tl_sm1_40_us_d2h[2];

  assign tl_sm1_59_us_h2d[1] = tl_s1n_73_ds_h2d[17];
  assign tl_s1n_73_ds_d2h[17] = tl_sm1_59_us_d2h[1];

  assign tl_sm1_60_us_h2d[1] = tl_s1n_73_ds_h2d[18];
  assign tl_s1n_73_ds_d2h[18] = tl_sm1_60_us_d2h[1];

  assign tl_sm1_61_us_h2d[1] = tl_s1n_73_ds_h2d[19];
  assign tl_s1n_73_ds_d2h[19] = tl_sm1_61_us_d2h[1];

  assign tl_sm1_62_us_h2d[1] = tl_s1n_73_ds_h2d[20];
  assign tl_s1n_73_ds_d2h[20] = tl_sm1_62_us_d2h[1];

  assign tl_sm1_63_us_h2d[1] = tl_s1n_73_ds_h2d[21];
  assign tl_s1n_73_ds_d2h[21] = tl_sm1_63_us_d2h[1];

  assign tl_sm1_64_us_h2d[1] = tl_s1n_73_ds_h2d[22];
  assign tl_s1n_73_ds_d2h[22] = tl_sm1_64_us_d2h[1];

  assign tl_sm1_65_us_h2d[1] = tl_s1n_73_ds_h2d[23];
  assign tl_s1n_73_ds_d2h[23] = tl_sm1_65_us_d2h[1];

  assign tl_sm1_66_us_h2d[1] = tl_s1n_73_ds_h2d[24];
  assign tl_s1n_73_ds_d2h[24] = tl_sm1_66_us_d2h[1];

  assign tl_sm1_67_us_h2d[1] = tl_s1n_73_ds_h2d[25];
  assign tl_s1n_73_ds_d2h[25] = tl_sm1_67_us_d2h[1];

  assign tl_sm1_68_us_h2d[1] = tl_s1n_73_ds_h2d[26];
  assign tl_s1n_73_ds_d2h[26] = tl_sm1_68_us_d2h[1];

  assign tl_sm1_69_us_h2d[1] = tl_s1n_73_ds_h2d[27];
  assign tl_s1n_73_ds_d2h[27] = tl_sm1_69_us_d2h[1];

  assign tl_sm1_70_us_h2d[1] = tl_s1n_73_ds_h2d[28];
  assign tl_s1n_73_ds_d2h[28] = tl_sm1_70_us_d2h[1];

  assign tl_sm1_71_us_h2d[1] = tl_s1n_73_ds_h2d[29];
  assign tl_s1n_73_ds_d2h[29] = tl_sm1_71_us_d2h[1];

  assign tl_sm1_72_us_h2d[1] = tl_s1n_73_ds_h2d[30];
  assign tl_s1n_73_ds_d2h[30] = tl_sm1_72_us_d2h[1];

  assign tl_s1n_34_us_h2d = tl_rv_core_ibex__corei_i;
  assign tl_rv_core_ibex__corei_o = tl_s1n_34_us_d2h;

  assign tl_rom_ctrl__rom_o = tl_sm1_35_ds_h2d;
  assign tl_sm1_35_ds_d2h = tl_rom_ctrl__rom_i;

  assign tl_rv_dm__mem_o = tl_sm1_36_ds_h2d;
  assign tl_sm1_36_ds_d2h = tl_rv_dm__mem_i;

  assign tl_sram_ctrl_main__ram_o = tl_sm1_37_ds_h2d;
  assign tl_sm1_37_ds_d2h = tl_sram_ctrl_main__ram_i;

  assign tl_sram_ctrl_sec__ram_o = tl_sm1_38_ds_h2d;
  assign tl_sm1_38_ds_d2h = tl_sram_ctrl_sec__ram_i;

  assign tl_flash_ctrl__mem_o = tl_sm1_39_ds_h2d;
  assign tl_sm1_39_ds_d2h = tl_flash_ctrl__mem_i;
  ...
  assign tl_flash_ctrl__core_o = tl_sm1_56_ds_h2d;
  assign tl_sm1_56_ds_d2h = tl_flash_ctrl__core_i;

  assign tl_flash_ctrl__prim_o = tl_sm1_57_ds_h2d;
  assign tl_sm1_57_ds_d2h = tl_flash_ctrl__prim_i;

  assign tl_rram_ctrl__core_o = tl_sm1_58_ds_h2d;
  assign tl_sm1_58_ds_d2h = tl_rram_ctrl__core_i;

  assign tl_rram_macro__prim_o = tl_sm1_59_ds_h2d;
  assign tl_sm1_59_ds_d2h = tl_rram_macro__prim_i;

  assign tl_aes_o = tl_sm1_60_ds_h2d;
  assign tl_sm1_60_ds_d2h = tl_aes_i;

  assign tl_entropy_src_o = tl_sm1_61_ds_h2d;
  assign tl_sm1_61_ds_d2h = tl_entropy_src_i;

  assign tl_csrng_o = tl_sm1_62_ds_h2d;
  assign tl_sm1_62_ds_d2h = tl_csrng_i;

  assign tl_edn0_o = tl_sm1_63_ds_h2d;
  assign tl_sm1_63_ds_d2h = tl_edn0_i;

  assign tl_edn1_o = tl_sm1_64_ds_h2d;
  assign tl_sm1_64_ds_d2h = tl_edn1_i;

  assign tl_hmac_o = tl_sm1_65_ds_h2d;
  assign tl_sm1_65_ds_d2h = tl_hmac_i;

  assign tl_rv_plic_o = tl_sm1_66_ds_h2d;
  assign tl_sm1_66_ds_d2h = tl_rv_plic_i;

  assign tl_otbn_o = tl_sm1_67_ds_h2d;
  assign tl_sm1_67_ds_d2h = tl_otbn_i;

  assign tl_keymgr_dpe_o = tl_sm1_68_ds_h2d;
  assign tl_sm1_68_ds_d2h = tl_keymgr_dpe_i;

  assign tl_kmac_o = tl_sm1_69_ds_h2d;
  assign tl_sm1_69_ds_d2h = tl_kmac_i;

  assign tl_sram_ctrl_main__regs_o = tl_sm1_70_ds_h2d;
  assign tl_sm1_70_ds_d2h = tl_sram_ctrl_main__regs_i;

  assign tl_sram_ctrl_sec__regs_o = tl_sm1_71_ds_h2d;
  assign tl_sm1_71_ds_d2h = tl_sram_ctrl_sec__regs_i;

  assign tl_rv_core_ibex__cfg_o = tl_sm1_72_ds_h2d;
  assign tl_sm1_72_ds_d2h = tl_rv_core_ibex__cfg_i;

  assign tl_s1n_73_us_h2d = tl_rv_dm__sba_i;
  assign tl_rv_dm__sba_o = tl_s1n_73_us_d2h;

  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_34 = 3'd6;
    if (((tl_s1n_34_us_h2d.a_address < (ADDR_SPACE_ROM_CTRL__ROM + ADDR_SIZE_ROM_CTRL__ROM)) &&
       (tl_s1n_34_us_h2d.a_address >= ADDR_SPACE_ROM_CTRL__ROM))) begin
      dev_sel_s1n_34 = 3'd0;
  ...
  always_comb begin
    ...
    if (((tl_s1n_41_us_h2d.a_address < (ADDR_SPACE_ROM_CTRL__ROM + ADDR_SIZE_ROM_CTRL__ROM)) &&
  ...
  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_73 = 5'd31;
    if (((tl_s1n_73_us_h2d.a_address < (ADDR_SPACE_ROM_CTRL__ROM + ADDR_SIZE_ROM_CTRL__ROM)) &&
       (tl_s1n_73_us_h2d.a_address >= ADDR_SPACE_ROM_CTRL__ROM))) begin
      dev_sel_s1n_73 = 5'd0;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_ROM_CTRL__REGS)) == ADDR_SPACE_ROM_CTRL__REGS) begin
      dev_sel_s1n_73 = 5'd1;
      ...
      ((tl_s1n_73_us_h2d.a_address & ~(ADDR_MASK_PERI[0])) == ADDR_SPACE_PERI[0]) ||
      ((tl_s1n_73_us_h2d.a_address & ~(ADDR_MASK_PERI[1])) == ADDR_SPACE_PERI[1])
    ) begin
      dev_sel_s1n_73 = 5'd6;
      ...
      dev_sel_s1n_73 = 5'd9;
                  ...
                  ~(ADDR_MASK_I3C0)) == ADDR_SPACE_I3C0) begin
      dev_sel_s1n_73 = 5'd10;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_I3C1)) == ADDR_SPACE_I3C1) begin
      dev_sel_s1n_73 = 5'd11;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_FLASH_CTRL__CORE)) == ADDR_SPACE_FLASH_CTRL__CORE) begin
      dev_sel_s1n_73 = 5'd12;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_FLASH_CTRL__PRIM)) == ADDR_SPACE_FLASH_CTRL__PRIM) begin
      dev_sel_s1n_73 = 5'd13;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_FLASH_CTRL__MEM)) == ADDR_SPACE_FLASH_CTRL__MEM) begin
      dev_sel_s1n_73 = 5'd14;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_RRAM_CTRL__CORE)) == ADDR_SPACE_RRAM_CTRL__CORE) begin
      dev_sel_s1n_73 = 5'd15;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_RRAM_CTRL__HOST)) == ADDR_SPACE_RRAM_CTRL__HOST) begin
      dev_sel_s1n_73 = 5'd16;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_RRAM_MACRO__PRIM)) == ADDR_SPACE_RRAM_MACRO__PRIM) begin
      dev_sel_s1n_73 = 5'd17;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_AES)) == ADDR_SPACE_AES) begin
      dev_sel_s1n_73 = 5'd18;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_ENTROPY_SRC)) == ADDR_SPACE_ENTROPY_SRC) begin
      dev_sel_s1n_73 = 5'd19;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_CSRNG)) == ADDR_SPACE_CSRNG) begin
      dev_sel_s1n_73 = 5'd20;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_EDN0)) == ADDR_SPACE_EDN0) begin
      dev_sel_s1n_73 = 5'd21;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_EDN1)) == ADDR_SPACE_EDN1) begin
      dev_sel_s1n_73 = 5'd22;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_HMAC)) == ADDR_SPACE_HMAC) begin
      dev_sel_s1n_73 = 5'd23;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_73 = 5'd24;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_OTBN)) == ADDR_SPACE_OTBN) begin
      dev_sel_s1n_73 = 5'd25;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_KEYMGR_DPE)) == ADDR_SPACE_KEYMGR_DPE) begin
      dev_sel_s1n_73 = 5'd26;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_KMAC)) == ADDR_SPACE_KMAC) begin
      dev_sel_s1n_73 = 5'd27;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_MAIN__REGS)) == ADDR_SPACE_SRAM_CTRL_MAIN__REGS) begin
      dev_sel_s1n_73 = 5'd28;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_SRAM_CTRL_SEC__REGS)) == ADDR_SPACE_SRAM_CTRL_SEC__REGS) begin
      dev_sel_s1n_73 = 5'd29;

    end else if ((tl_s1n_73_us_h2d.a_address &
                  ~(ADDR_MASK_RV_CORE_IBEX__CFG)) == ADDR_SPACE_RV_CORE_IBEX__CFG) begin
      dev_sel_s1n_73 = 5'd30;
end
  end
  ...
  tlul_socket_1n #(
    ...
    .clk_i        (clk_main_i),
    .rst_ni       (rst_main_ni),
    .tl_h_i       (tl_s1n_73_us_h2d),
    .tl_h_o       (tl_s1n_73_us_d2h),
    .tl_d_o       (tl_s1n_73_ds_h2d),
    .tl_d_i       (tl_s1n_73_ds_d2h),
    .dev_select_i (dev_sel_s1n_73)
  );
