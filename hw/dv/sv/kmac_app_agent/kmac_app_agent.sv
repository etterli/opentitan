...
class kmac_app_agent extends dv_reactive_agent #(
  ...
  function void build_phase(uvm_phase phase);
    ...
    // Response push agent runs in both interface modes.
    //   Host mode:   Assert rsp_ready with random delay to emulate back pressure.
    //                providing back pressure.
    //   Device mode: Send responses with random delay.
