...
#(
        ...
        InsnOpcodeBignumArith: begin
          unique case (imem_rdata_i[14:12])
            ...
            3'b101: begin
              ...
              rf_ren_b_bignum                   = 1'b1;
              rf_we_bignum                      = 1'b1;
              // There is no shifting performed, so take same  value as decoder
              alu_bignum_shift_amt              = shift_amt_a_type_bignum;
  ...
  assign alu_bignum_predec_o.vec_adder_carry_sel    = alu_bignum_vec_adder_carry_sel;
  assign alu_bignum_predec_o.vec_mod_selector_en    = alu_bignum_vec_mod_selector_en;
  assign alu_bignum_predec_o.vec_mod_is_subtraction = alu_bignum_vec_mod_is_subtraction;
  ...
  assign mac_bignum_predec_o.mul_type        = mac_bignum_mul_type;
