...
#(
  ...
  logic [NELEN_ALU-1:0] alu_bignum_alu_elen_onehot;
  trn_elen_e            alu_bignum_trn_elen;
  logic [NELEN_TRN-1:0] alu_bignum_trn_elen_onehot;
  ...
  prim_onehot_enc #(
    ...
    .in_i (alu_bignum_alu_elen),
    .en_i ('1), // always enable
    .out_o(alu_bignum_alu_elen_onehot)
  );

  prim_onehot_enc #(
    .OneHotWidth (NELEN_TRN)
  ) u_trn_elen_onehot_enc (
    .in_i (alu_bignum_trn_elen),
    .en_i ('1), // always enable
    .out_o(alu_bignum_trn_elen_onehot)
  );
  ...
  always_comb begin
    ...
    alu_bignum_vec_adder_carry_sel    = '0;
    ...
    if (imem_rvalid_i) begin
      ...
      //   overflowing bits.
      unique case (alu_bignum_alu_elen) // TODO: Make dynamic depending on VLEN, etc..
        AluElen32: begin
          alu_bignum_vec_adder_carry_sel = {8{1'b1}};
          alu_bignum_shift_mask          = (32'd1 << ( 32-alu_bignum_shift_amt)) - 32'd1;
        end
        AluElen256: begin
          alu_bignum_vec_adder_carry_sel = 8'd1;
  ...
  assign alu_predec_bignum_o.alu_elen_onehot        = alu_bignum_alu_elen_onehot;
  ...
  assign alu_predec_bignum_o.trn_elen_onehot        = alu_bignum_trn_elen_onehot;
  assign alu_predec_bignum_o.trn_en                 = alu_bignum_trn_en;
  assign alu_predec_bignum_o.trn_is_trn1            = alu_bignum_trn_is_trn1;
