...
#(
  ...
  otbn_mac_bignum_fsm u_mac_bignum_fsm (
    ...
    // Therefore, we can ignore this error here. This ensures that all multi-cycle multiplications
    // escalate at the earliest when they are executed (like any other instruction).
    .state_err_o()
  );
