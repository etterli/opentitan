...
#(
  ...
  assign alu_bignum_operation_o.alu_elen_onehot     = insn_dec_bignum_i.alu_elen_onehot;
  assign alu_bignum_operation_o.trn_elen_onehot     = insn_dec_bignum_i.trn_elen_onehot;
  ...
  assign mac_bignum_operation_o.elen_ctrl         = insn_dec_bignum_i.mac_elen_ctrl;
  ...
  always_comb begin
    ...
    // TODO: Check this regarding hardening. The (predecoded) write enable signals are always set
    //       during these stall cycles. If they may not be set, a solution similar to the indirect
    //       rf access must be implemented.
