 ...
 * chunk. I.e., for 256-bit operations the decision of the top chunk selects the result for all
 * other chunks and for 32-bit operations each chunk decides on its own.
 *
 ...
 * addition this signal is always set as the carry of Y is used for the comparison.
 */
