...
#(
  ...
  logic [LNVecProc-1:0] select_y_all[NELEN_ALU];

  // TODO: Can this be generalized such that it depends on the vector chunk length (for other
  //       ELENs as well)?

  assign select_y_all[AluElen32] = decided_for_y;

  assign select_y_all[AluElen256] = {LNVecProc{decided_for_y[LNVecProc-1]}};
