...
#(
  ...
  // Check that kmac_data_o.last is "telling the truth": kmac_data_o.rsp_valid should drop on the
  // cycle after the word that it decorates is transferred.
  `ASSERT(KmacLastTrue_A,
          kmac_data_o.req_valid && kmac_data_i.req_ready && kmac_data_o.last
