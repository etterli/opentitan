...
pub enum AlertId {
    ...
    AonTimerFatalFault = 21,
    /// soc_proxy_fatal_alert_intg
    SocProxyFatalAlertIntg = 22,
    /// sram_ctrl_ret_fatal_error
    SramCtrlRetFatalError = 23,
    /// rv_dm_fatal_fault
    RvDmFatalFault = 24,
    /// rv_plic_fatal_fault
    RvPlicFatalFault = 25,
    /// aes_recov_ctrl_update_err
    AesRecovCtrlUpdateErr = 26,
    /// aes_fatal_fault
    AesFatalFault = 27,
    /// hmac_fatal_fault
    HmacFatalFault = 28,
    /// kmac_recov_operation_err
    KmacRecovOperationErr = 29,
    /// kmac_fatal_fault_err
    KmacFatalFaultErr = 30,
    /// otbn_fatal
    OtbnFatal = 31,
    /// otbn_recov
    OtbnRecov = 32,
    /// keymgr_dpe_recov_operation_err
    KeymgrDpeRecovOperationErr = 33,
    /// keymgr_dpe_fatal_fault_err
    KeymgrDpeFatalFaultErr = 34,
    /// csrng_recov_alert
    CsrngRecovAlert = 35,
    /// csrng_fatal_alert
    CsrngFatalAlert = 36,
    /// entropy_src_recov_alert
    EntropySrcRecovAlert = 37,
    /// entropy_src_fatal_alert
    EntropySrcFatalAlert = 38,
    /// edn0_recov_alert
    Edn0RecovAlert = 39,
    /// edn0_fatal_alert
    Edn0FatalAlert = 40,
    ...
    SramCtrlMainFatalError = 43,
    /// sram_ctrl_mbox_fatal_error
    SramCtrlMboxFatalError = 44,
    /// rom_ctrl0_fatal
    RomCtrl0Fatal = 45,
    /// rom_ctrl1_fatal
    RomCtrl1Fatal = 46,
...
impl TryFrom<u32> for AlertId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            17 => Ok(Self::RstmgrFatalSecTest),
            18 => Ok(Self::ClkmgrRecovFault),
            19 => Ok(Self::ClkmgrFatalFault),
            20 => Ok(Self::PinmuxFatalFault),
            21 => Ok(Self::AonTimerFatalFault),
            22 => Ok(Self::SocProxyFatalAlertIntg),
            23 => Ok(Self::SramCtrlRetFatalError),
            24 => Ok(Self::RvDmFatalFault),
            25 => Ok(Self::RvPlicFatalFault),
            26 => Ok(Self::AesRecovCtrlUpdateErr),
            27 => Ok(Self::AesFatalFault),
            28 => Ok(Self::HmacFatalFault),
            29 => Ok(Self::KmacRecovOperationErr),
            30 => Ok(Self::KmacFatalFaultErr),
            31 => Ok(Self::OtbnFatal),
            32 => Ok(Self::OtbnRecov),
            33 => Ok(Self::KeymgrDpeRecovOperationErr),
            34 => Ok(Self::KeymgrDpeFatalFaultErr),
            35 => Ok(Self::CsrngRecovAlert),
            36 => Ok(Self::CsrngFatalAlert),
            37 => Ok(Self::EntropySrcRecovAlert),
            38 => Ok(Self::EntropySrcFatalAlert),
            39 => Ok(Self::Edn0RecovAlert),
            40 => Ok(Self::Edn0FatalAlert),
            41 => Ok(Self::Edn1RecovAlert),
            42 => Ok(Self::Edn1FatalAlert),
            43 => Ok(Self::SramCtrlMainFatalError),
            44 => Ok(Self::SramCtrlMboxFatalError),
            45 => Ok(Self::RomCtrl0Fatal),
            46 => Ok(Self::RomCtrl1Fatal),
            47 => Ok(Self::DmaFatalFault),
...
pub const ALERT_FOR_PERIPHERAL: [AlertPeripheral; 78] = [
    ...
    AlertPeripheral::Rstmgr,
    // RstmgrFatalSecTest -> AlertPeripheral::Rstmgr
    AlertPeripheral::Rstmgr,
