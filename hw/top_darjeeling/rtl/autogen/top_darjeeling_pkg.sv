...
package top_darjeeling_pkg;
  ...
  */
  ...
  typedef enum int unsigned {
    ...
    TopDarjeelingAlertIdRstmgrFatalSecTest = 17,
    TopDarjeelingAlertIdClkmgrRecovFault = 18,
    TopDarjeelingAlertIdClkmgrFatalFault = 19,
    TopDarjeelingAlertIdPinmuxFatalFault = 20,
    TopDarjeelingAlertIdAonTimerFatalFault = 21,
    TopDarjeelingAlertIdSocProxyFatalAlertIntg = 22,
    TopDarjeelingAlertIdSramCtrlRetFatalError = 23,
    TopDarjeelingAlertIdRvDmFatalFault = 24,
    TopDarjeelingAlertIdRvPlicFatalFault = 25,
    TopDarjeelingAlertIdAesRecovCtrlUpdateErr = 26,
    TopDarjeelingAlertIdAesFatalFault = 27,
    TopDarjeelingAlertIdHmacFatalFault = 28,
    TopDarjeelingAlertIdKmacRecovOperationErr = 29,
    TopDarjeelingAlertIdKmacFatalFaultErr = 30,
    TopDarjeelingAlertIdOtbnFatal = 31,
    TopDarjeelingAlertIdOtbnRecov = 32,
    TopDarjeelingAlertIdKeymgrDpeRecovOperationErr = 33,
    TopDarjeelingAlertIdKeymgrDpeFatalFaultErr = 34,
    TopDarjeelingAlertIdCsrngRecovAlert = 35,
    TopDarjeelingAlertIdCsrngFatalAlert = 36,
    TopDarjeelingAlertIdEntropySrcRecovAlert = 37,
    TopDarjeelingAlertIdEntropySrcFatalAlert = 38,
    TopDarjeelingAlertIdEdn0RecovAlert = 39,
    TopDarjeelingAlertIdEdn0FatalAlert = 40,
    TopDarjeelingAlertIdEdn1RecovAlert = 41,
    TopDarjeelingAlertIdEdn1FatalAlert = 42,
    TopDarjeelingAlertIdSramCtrlMainFatalError = 43,
    TopDarjeelingAlertIdSramCtrlMboxFatalError = 44,
    TopDarjeelingAlertIdRomCtrl0Fatal = 45,
    TopDarjeelingAlertIdRomCtrl1Fatal = 46,
    TopDarjeelingAlertIdDmaFatalFault = 47,
    TopDarjeelingAlertIdMbx0FatalFault = 48,
    TopDarjeelingAlertIdMbx0RecovFault = 49,
    TopDarjeelingAlertIdMbx1FatalFault = 50,
    TopDarjeelingAlertIdMbx1RecovFault = 51,
    TopDarjeelingAlertIdMbx2FatalFault = 52,
    TopDarjeelingAlertIdMbx2RecovFault = 53,
    TopDarjeelingAlertIdMbx3FatalFault = 54,
    TopDarjeelingAlertIdMbx3RecovFault = 55,
    TopDarjeelingAlertIdMbx4FatalFault = 56,
    TopDarjeelingAlertIdMbx4RecovFault = 57,
    TopDarjeelingAlertIdMbx5FatalFault = 58,
    TopDarjeelingAlertIdMbx5RecovFault = 59,
    TopDarjeelingAlertIdMbx6FatalFault = 60,
    TopDarjeelingAlertIdMbx6RecovFault = 61,
    TopDarjeelingAlertIdMbxJtagFatalFault = 62,
    TopDarjeelingAlertIdMbxJtagRecovFault = 63,
    TopDarjeelingAlertIdMbxPcie0FatalFault = 64,
    TopDarjeelingAlertIdMbxPcie0RecovFault = 65,
    TopDarjeelingAlertIdMbxPcie1FatalFault = 66,
    TopDarjeelingAlertIdMbxPcie1RecovFault = 67,
    TopDarjeelingAlertIdSocDbgCtrlFatalFault = 68,
    TopDarjeelingAlertIdSocDbgCtrlRecovCtrlUpdateErr = 69,
    TopDarjeelingAlertIdRaclCtrlFatalFault = 70,
    TopDarjeelingAlertIdRaclCtrlRecovCtrlUpdateErr = 71,
    TopDarjeelingAlertIdAcRangeCheckRecovCtrlUpdateErr = 72,
    TopDarjeelingAlertIdAcRangeCheckFatalFault = 73,
    TopDarjeelingAlertIdRvCoreIbexFatalSwErr = 74,
    TopDarjeelingAlertIdRvCoreIbexRecovSwErr = 75,
    TopDarjeelingAlertIdRvCoreIbexFatalHwErr = 76,
    TopDarjeelingAlertIdRvCoreIbexRecovHwErr = 77,
