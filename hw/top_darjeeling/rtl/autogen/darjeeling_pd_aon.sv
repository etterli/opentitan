...
module darjeeling_pd_aon #(
  ...
  input  rom_ctrl_pkg::pwrmgr_data_t [2:0] pwrmgr_rom_ctrl_i,
  ...
  assign pwrmgr_boot_status_o = pwrmgr_boot_status;
  assign pwrmgr_wakeups[0] = pwrmgr_wakeups_i;
  assign pwrmgr_boot_status_obs_o = pwrmgr_boot_status;
  ...
  pwrmgr #(
    ...
    .clk_esc_i(clkmgr_clocks.clk_io_secure),
    ...
    .rst_lc_ni(rstmgr_resets.rst_lc_io_n[rstmgr_pkg::DomainAonSel]),
    .rst_esc_ni(rstmgr_resets.rst_lc_io_n[rstmgr_pkg::DomainAonSel]),
    ...
    .boot_status_o(pwrmgr_boot_status),
  ...
  clkmgr #(
    ...
    .clk_io_i(clk_io_i),
    .clk_aon_i(clk_aon_i),
    .rst_shadowed_ni(rstmgr_resets.rst_lc_io_shadowed_n[rstmgr_pkg::DomainAonSel]),
    .rst_ni(rstmgr_resets.rst_lc_io_n[rstmgr_pkg::DomainAonSel]),
  ...
  aon_timer #(
    ...
    .aon_timer_rst_req_o(pwrmgr_rstreqs[0]),
  ...
  soc_proxy #(
    ...
    .clk_aon_i(clkmgr_clocks.clk_aon_infra),
    ...
    .wkup_external_req_o(pwrmgr_wakeups[2]),
    .rst_req_external_o(pwrmgr_rstreqs[1]),
  ...
  sram_ctrl #(
    ...
    .clk_otp_i(clkmgr_clocks.clk_io_infra),
    .rst_ni(rstmgr_resets.rst_lc_io_n[rstmgr_pkg::DomainAonSel]),
    ...
    .ram_cfg_i(sram_ctrl_ret_ram_cfg_req_i),
    .ram_cfg_o(sram_ctrl_ret_ram_cfg_rsp_o),
    .lc_escalate_en_i(lc_ctrl_lc_escalate_en_i),
